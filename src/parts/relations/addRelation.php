...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Add new Relation Scenario Assessment</h1>
</div>
...
<!--Formular-->
        ...
        <form action="<?php echo CoreFunctions::ACTION_ADD_WCSA; ?>" method="POST">
            ...
            <input type="text" class="form-control" name="wcsa_name" placeholder="!!! Type Aspect and value, e.g. Dataclass (1)" >
            </div>
