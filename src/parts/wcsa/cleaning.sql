...
-- architect
UPDATE `wcsa` SET `architect` = '0' WHERE `wcsa_name` != 'WCS' AND `architect` IS NULL;
UPDATE `wcsa` SET `architect` = '4' WHERE `wcsa_name` != 'WCS' AND `architect` LIKE '%4%';
UPDATE `wcsa` SET `architect` = '5' WHERE `wcsa_name` != 'WCS' AND `architect` LIKE '%5%';
UPDATE `wcsa` SET `architect` = '7' WHERE `wcsa_name` != 'WCS' AND `architect` LIKE '%7%';
UPDATE `wcsa` SET `architect` = '9' WHERE `wcsa_name` != 'WCS' AND `architect` LIKE '%9%';


-- netloc
UPDATE `wcsa` SET `netloc` = '0' WHERE `wcsa_name` != 'WCS' AND `netloc` IS NULL;
...
-- authfact
UPDATE `wcsa` SET `authfact` = '0' WHERE `wcsa_name` != 'WCS' AND `authfact` IS NULL;
...
-- sign
UPDATE `wcsa` SET `sign` = '0' WHERE `wcsa_name` != 'WCS' AND `sign` IS NULL;
...
-- enc
UPDATE `wcsa` SET `enc` = '0' WHERE `wcsa_name` != 'WCS' AND `enc` IS NULL;
...
-- userpriv
UPDATE `wcsa` SET `userpriv` = '0' WHERE `wcsa_name` != 'WCS' AND `userpriv` IS NULL;
