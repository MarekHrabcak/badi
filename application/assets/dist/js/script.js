...
const partials = ["sl", "m", "o", "s", "ed", "ee", "a", "ide", "lc", "li", "lav", "lac", "fd", "rd", "nc", "pv"];
...
function calculate(){
  ...
  // score = score + ')';
  $('#score').text(score);
  $("#score").attr("href", "http://localhost/badi/dashboard/ocalc.php?vector=(" + score + ")");
